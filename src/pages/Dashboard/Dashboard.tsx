...
export const Dashboard = () => {
    ...
    useEffect(() => {
        (async () => {
            ...
            if (!error && data) setRoom(data as any as Room);
        ...
        <div className="flex min-h-screen overflow-hidden">
            ...
            <aside className="border-secondary border-r-2">
                ...
                <nav className="flex flex-col h-screen w-[14rem] lg:w-[16rem] pt-4 px-2 space-y-1">
                    ...
                    <Link to="focusroom" className="relative inline-flex items-center mx-2 bg-transparent text-foreground rounded-xl p-2 gap-3 hover:bg-secondary focus:bg-secondary focus:font-bold">
